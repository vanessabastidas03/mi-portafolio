import { GraduationCap, MapPin, Calendar, Code2, BookOpen, Star } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-purple-700">Conoce más sobre mi trayectoria académica y pasiones</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-white/70 backdrop-blur-sm shadow-lg border border-purple-200 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-purple-800">Educación</h3>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <BookOpen className="w-4 h-4 text-purple-500" />
                <span className="text-purple-700 font-medium">Ingeniería de Software</span>
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-purple-500" />
                <span className="text-purple-600">Universidad Cooperativa de Colombia - Pasto</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="p-6 bg-white/70 backdrop-blur-sm shadow-lg border border-purple-200 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-purple-800">Habilidades</h3>
            </div>
        ...
        <div className="mt-8 p-8 bg-gradient-to-br from-purple-500 to-pink-500 text-white shadow-xl border-0 rounded-lg">
          ...
          <p className="text-purple-100 leading-relaxed text-center">
            Como estudiante de Ingeniería de Software en la Universidad Cooperativa de Colombia en Pasto, me apasiona el
            mundo de la tecnología y el desarrollo de software. Cada día es una oportunidad para aprender algo nuevo y
            aplicar mis conocimientos en proyectos creativos que marquen la diferencia. Mi objetivo es convertirme en
            una desarrolladora que no solo escriba código, sino que cree experiencias digitales memorables.
          </p>
        </div>
